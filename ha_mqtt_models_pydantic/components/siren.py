...
class Siren(MqttEntityCommon, MqttReadWrite):
    ...
    support_duration: Annotated[bool | None, Field(alias=CONF_SUPPORT_DURATION)] = True
    support_volume_set: Annotated[bool | None, Field(alias=CONF_SUPPORT_VOLUME_SET)] = True
