...
class LightJson(_BaseLight, MqttBase):
    brightness: Annotated[bool | None, Field(alias=CONF_BRIGHTNESS)] = DEFAULT_BRIGHTNESS
    brightness_scale: Annotated[int | None, Field(alias=CONF_BRIGHTNESS_SCALE, gt=0)] = DEFAULT_BRIGHTNESS_SCALE
    color_temp_kelvin: Annotated[bool | None, Field(alias=CONF_COLOR_TEMP_KELVIN)] = False
    command_topic: Annotated[str, Field(alias=CONF_COMMAND_TOPIC, min_length=1)]
    effect: Annotated[bool | None, Field(alias=CONF_EFFECT)] = DEFAULT_EFFECT
    effect_list: Annotated[list[str] | None, Field(alias=CONF_EFFECT_LIST)] = None
    flash: Annotated[bool | None, Field(alias=CONF_FLASH)] = True
    flash_time_long: Annotated[int | None, Field(alias=CONF_FLASH_TIME_LONG, gt=0)] = DEFAULT_FLASH_TIME_LONG
    flash_time_short: Annotated[int | None, Field(alias=CONF_FLASH_TIME_SHORT, gt=0)] = DEFAULT_FLASH_TIME_SHORT
    ...
    optimistic: Annotated[bool | None, Field(alias="optimistic")] = DEFAULT_OPTIMISTIC
    ...
    transition: Annotated[bool | None, Field(alias=CONF_TRANSITION)] = True
    white_scale: Annotated[int | None, Field(alias=CONF_WHITE_SCALE, gt=0)] = DEFAULT_WHITE_SCALE
    light_schema: Annotated[str | None, Field(alias=CONF_SCHEMA)] = "json"
...
class LightBasic(_BaseLight, MqttReadWrite):
    ...
    min_kelvin: Annotated[int | None, Field(alias=CONF_MIN_KELVIN, gt=0)] = None
    min_mireds: Annotated[int | None, Field(alias=CONF_MIN_MIREDS, gt=0)] = None
    on_command_type: Annotated[str | None, Field(alias=CONF_ON_COMMAND_TYPE)] = DEFAULT_ON_COMMAND_TYPE
    ...
    light_schema: Annotated[str | None, Field(alias=CONF_SCHEMA)] = "basic"
...
class LightTemplate(_BaseLight, MqttReadWrite):
    ...
    light_schema: Annotated[str | None, Field(alias=CONF_SCHEMA)] = "template"
