...
class Lock(MqttEntityCommon, MqttReadWrite):
    ...
    payload_lock: Annotated[str, Field(alias=CONF_PAYLOAD_LOCK)] = DEFAULT_PAYLOAD_LOCK
    payload_open: Annotated[str, Field(alias=CONF_PAYLOAD_OPEN)] = DEFAULT_PAYLOAD_OPEN
    payload_reset: Annotated[str, Field(alias=CONF_PAYLOAD_RESET)] = DEFAULT_PAYLOAD_RESET
    payload_unlock: Annotated[str, Field(alias=CONF_PAYLOAD_UNLOCK)] = DEFAULT_PAYLOAD_UNLOCK
    state_jammed: Annotated[str, Field(alias=CONF_STATE_JAMMED)] = DEFAULT_STATE_JAMMED
    state_locked: Annotated[str, Field(alias=CONF_STATE_LOCKED)] = DEFAULT_STATE_LOCKED
    state_locking: Annotated[str, Field(alias=CONF_STATE_LOCKING)] = DEFAULT_STATE_LOCKING
    ...
    state_unlocked: Annotated[str, Field(alias=CONF_STATE_UNLOCKED)] = DEFAULT_STATE_UNLOCKED
    state_unlocking: Annotated[str, Field(alias=CONF_STATE_UNLOCKING)] = DEFAULT_STATE_UNLOCKING
